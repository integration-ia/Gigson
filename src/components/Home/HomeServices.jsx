...
function HomeServices() {
  return (
    <section className='home-services' id='homeServices'>
        ...
        <h2 className='home-services-h2'>Tailored <span>solutions</span> for any business Tailored. <span>solutions</span> for any business. Tailored <span>solutions</span> for any business Tailored. <span>solutions</span> for any business. </h2>
